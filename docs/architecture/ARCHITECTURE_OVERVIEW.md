...
16. Frontend responsibility ends at authoring state, flush confirmation, preview request/link shaping, and checkout initiation. Backend responsibility starts at prepared draft preview, publish preflight, asset normalization for public delivery, lifecycle gating, HTML artifact generation, and publication metadata writes.
