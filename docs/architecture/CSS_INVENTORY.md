...
| Dashboard header | `src/components/DashboardHeader.jsx` | Tailwind in JSX plus static inline avatar color and runtime `--dashboard-header-height` | Owns `[data-dashboard-header="true"]` and `[data-preserve-canvas-selection="true"]`. |
