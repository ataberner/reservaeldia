...
This map reflects the current repository behavior on 2026-03-27.
...
| --- | --- | --- |
| `src/components/CanvasEditor.jsx` and editor interaction runtime | Very High | selection, multi-selection, drag, inline editing, resize, rotation, globals, and external bridges still converge here |
