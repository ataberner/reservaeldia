      ...
      >
        <div className="px-5 pt-5 pb-4 border-b border-slate-100">
          <div className="flex items-start gap-3">
            ...
            <div>
              <h2 id="delete-section-title" className="text-base font-semibold text-slate-900">
                Borrar seccion
              </h2>
              <p id="delete-section-description" className="mt-1 text-sm text-slate-600">
                Vas a borrar la seccion <span className="font-medium text-slate-800">"{safeSectionName}"</span>.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="px-5 py-4">
          <div className="rounded-xl border border-amber-200 bg-amber-50 px-3 py-3 text-sm text-amber-900">
            Se van a borrar <span className="font-semibold">{elementosTexto}</span> que pertenecen a esta seccion.
          </div>
